...
pub struct Exercise<'info> {
    ...
    #[account(mut)]
    pub user_option_account: Box<Account<'info, TokenAccount>>,
...
impl<'info> Exercise<'info> {
    pub fn validate_accounts(&self, _amount: u64) -> Result<()> {
        // TODO: Verify the strike is correct and thus the SO matches.
        ...
        // Verify the address of usdc account.
        assert_keys_eq!(
